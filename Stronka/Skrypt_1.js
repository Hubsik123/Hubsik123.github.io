    ...
    switch(RNG)
    {
        ...
        case 5:
        {
            ...
            Spoiler.onclick = function()
            {
                ...
                {
                    document.getElementById("Message").innerHTML = "Nigdy nie rozumiałem ludzi, którzy zawsze mówili że książki są delikatnie mówiąc lepsze niż gry komputerowe, wręcz najwyższą (patrz jedyną) formą intelektualnej rozrywki. Na podtrzymanie (patrz wpajanie) tej teori przytaczane były argumenty że książki poszerzają horyzonty, uczą w sumie wszystkiego co się tylko da (SPOILER ALERT: Gry też poszerzają horyzonty i uczą)... Ale niestety często te oczytane i obeznane w świecie (antycznym) osoby nie tolerowały jakiejkolwiek formy gry komputerowej... Twierdząć że to strata czasu i prowadzenie do tego że mózgi nam zgniją, że nic przez nie nie osiągniemy w życiu, że to po prostu jest złe... Ale moim zdaniem - uważam takie osoby są po prostu nie toleranycjne (mimo tego, że książki podobno uczą tolerancji), zachowywanie się w ten sposób jest po prostu niekulturalne (mam nadzieje że ta myśl zostanie z Tobą na dłużej i przemyślisz swoje poglądy na temat tego jak to książki są i powinny być jedyną dozwoloną formą intelektualnej rozrywki). A argumenty typu 'Od czytania jest siem momdrzejszym', 'tam się tylko w obrazki klika' (A co właśnie robisz? Czytasz z komputra! Jak uruchomiłeś przeglądarkę? Jak kliknąłeś w guzik który wyświetla ten tekst?). Ale jakimś cudem mój mózg ma się w miarę dobrze i to jakoś Ty własnie korzystasz z tej skoromnej stronki i wszystkich plików które są tutaj dostępne. Które zostały zrobione w 200% pod wpływem korzystania z tych całych gier komputerowych. I właśnie dzięki robieniu tej strony nauczyłem się wielu pożytecznych rzeczy. Jeśli do Ciebie był skierowany ten krótki tekst - to nie pozdrawiam! Mam nadzieje, że przyczepisz się do błędów ortograficznych czy składni a nie (słabych) argumentów, których pewnie nawet nie będziesz chciałe przeczytać.<br>PS: Jak już To 'Diablo' to gra o egzorcyście.<br>PS 2: Jestem bardzo ciekawy dlaczego na każdym etapie mojej edukacji był moment w którym ktoś kazał iść do 'bibloteki' dlatego, że ilość odwiedziń uczniów się nie zgadzała...<br>PS 3: Pasowałoby żeby w szkolnej bilbiotece w dziele 'Informatyka' było troche nowsze książki... Raz widziałem tak 'coś' o robieniu pierwszych na świecie stron internetowych, książka ta wspominała przeglądarkę... uwaga... Netscape Navigator (Poszukaj na Wikipedii)... Raz nawet widziłem coś w stylu 'Windows 95 i ty', 'System Operacyjny przeszłości'... ";
